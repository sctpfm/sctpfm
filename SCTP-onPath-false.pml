...
chan AtoC = [0] of { mtype:msgs, bit, bit }; /* chunk, vtag, itag */
chan CtoA = [0] of { mtype:msgs, bit, bit }; /* chunk, vtag, itag */
chan BtoC = [0] of { mtype:msgs, bit, bit }; /* chunk, vtag, itag */
chan CtoB = [0] of { mtype:msgs, bit, bit }; /* chunk, vtag, itag */
